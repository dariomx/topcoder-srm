...
care. If it lies within, we need to shift our start index to one position
after the last seen index.
...
substring needs to be a continuous section, a guy in the middle can actually
